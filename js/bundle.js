...
function calc() {
  ...
  function getDinamicInformation(selector) {
    ...
    input.addEventListener('input', function () {
      if (input.value.match(/\D/g)) {
        ...
        input.style.boxShadow = '0 4px 15px rgba(255, 0, 0, 0.2)';
      } else {
        input.style.border = 'none';
        input.style.boxShadow = '0 4px 15px rgba(0, 0, 0, 0.2)';
      }
      ...
      switch (input.getAttribute('id')) {
        ...
        default:
          console.log("Sorry, we are out of ".concat(input.getAttribute('id'), "."));
      }
  ...
  getDinamicInformation('#age'); // Calc end
} // module.exports = calc;
...
function forms(formSelect, modalTimerId) {
  //Forms SATRT
  var forms = document.querySelectorAll(formSelect);
  var message = {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMessage = document.createElement('img'); // statusMessage.classList.add('status');
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)('.modal');
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  ...
  var modal = document.querySelector(modalSelector); // const modalCloseBtn = document.querySelector('[data-close]');
  ...
  window.addEventListener('scroll', showModalByScroll); // modal END
...
function slider(_ref) {
  var container = _ref.container,
      ...
      curentCounter = _ref.curentCounter,
  ...
  var slideIndex = 1;
  var offset = 0; // second type slider start
  ...
  }); // second type slider end
  // first type slider start
...
function tabs(_ref) {
  var tabsSelector = _ref.tabsSelector,
...
function timer(idTimer, deadline) {
  ...
  setClock(idTimer, deadline); // timer END
...
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/cards */ "./js/modules/cards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.default)('.modal', modalTimerId);
  }, 300000);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            throw new Error("Could not fetch ".concat(url, ", staus: ").concat(res.staus));
